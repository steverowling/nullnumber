...
class NullNumberPlugin extends BasePlugin
{
    /**
    ...
    {
        return Craft::t('Extension of the built-in Number field with a default value of null.');
    }
    ...
    {
        return 'https://github.com/steverowling/nullnumber/blob/master/README.md';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/steverowling/nullnumber/master/releases.json';
    }
